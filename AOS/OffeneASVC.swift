...
class OffeneASVC: UITableViewController, ASIDDelegate{    
    
    let URL_GET_OAS = "http://aos.ssit.at/php/v1/offeneAS.php"
        ...
        Alamofire.request(URL_GET_OAS, method: .get).responseJSON{
            ...
            if let result = response.result.value{
                ...
                if(!(jsonData.value(forKey: "error") as! Bool)){
                    ...
                    let oas = jsonData.value(forKey: "offeneAS") as! NSArray
                    //print(oas)
